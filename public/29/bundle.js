...
var _BarycentricMaterial = __webpack_require__(111);
...
var Experiment = function (_ThreeApp) {
  ...
  _createClass(Experiment, [{
    ...
    value: function init() {
      ...
      _BarycentricMaterial2.default.applyBarycentricCoordinates(this.geometry);
      this.mesh = new _three.Mesh(this.geometry, new _BarycentricMaterial2.default({
        width: 1
      }));
...
var _barycentricVert = __webpack_require__(112);

var _barycentricVert2 = _interopRequireDefault(_barycentricVert);

var _barycentricFrag = __webpack_require__(113);
  ...
  function BarycentricMaterial() {
    ...
    return _possibleConstructorReturn(this, (BarycentricMaterial.__proto__ || Object.getPrototypeOf(BarycentricMaterial)).call(this, {
      uniforms: {
        ...
        time: { value: 0 },
        noiseMod: { value: props.noiseMod },
        posDampen: { value: props.posDampen }
      },
